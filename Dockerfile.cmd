...
# ARG BUILD_TARGET
# ARG MODE
COPY --from=builder --chown=nonroot "/go/src/ns-open-match/build/cmd/${IMAGE_TITLE}/" "/app/"
# COPY install/matchmaker_config_default${MODE}.yaml /app/matchmaker_config_default.yaml
# COPY install/matchmaker_config_override${BUILD_TARGET}.yaml /app/matchmaker_config_override.yaml
COPY install/matchmaker_config_default.yaml /app/matchmaker_config_default.yaml
COPY install/matchmaker_config_override.yaml /app/matchmaker_config_override.yaml
